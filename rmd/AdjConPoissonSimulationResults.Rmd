---
title: "TPRS Poisson Regression with changing confounders"
...
library(readr)
```
This simulation looks at the effectiveness of varying degrees of freedom (up to 100) of Thin Plate Regression Splines as basis functions in a Poisson Regression to try to remove spatial confounding. The confounding surface is recreated at the start of every loop/sample of the simulation. The true b1 is 1, and is our target. Samples of size 1000 were taken 50 times. Two situations were examined: g = .1/c = .25 and g = .25/c = .25.
...
dateTime <- "26June2023-21:28"


#Insert GP settings here in form "X.XX". Include leading zero.         Ex.         "0.1"        "0.25"
#(Files found in RawData/)

G = "0.1"


estimatesRMD = read_csv(file =paste0("../RawData/",dateTime,"-G:",G,"-EstimatesMatrixAdjConPoisson.csv"))
b0estimatesRMD = read_csv(file = paste0("../RawData/",dateTime,"-G:",G,"-b0estimatesMatrixAdjConPoisson.csv"))
coverageRMD = read_csv(file = paste0("../RawData/",dateTime,"-G:",G,"-CoverageMatrixAdjConPoisson.csv"))
standardErrorRMD = read_csv(file = paste0("../RawData/",dateTime,"-G:",G,"-StandardErrorMatrixAdjConPoisson.csv"))
```
...
```{r, echo=FALSE}
print(paste0("X created using a spectral density of: ",G ))
...
This had positive results in generally bringing b1 closer to 1, reducing error and having good coverage. b0 still very large however. 
